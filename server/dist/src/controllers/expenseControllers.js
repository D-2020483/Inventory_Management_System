...
exports.createExpense = exports.getExpensesByCategory = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const getExpensesByCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const expenseByCategorySummaryRaw = yield prisma.expenses.findMany({
            orderBy: {
                timestamp: "desc",
            },
        });
...
const createExpense = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newExpense = yield prisma.expenses.create({ data });
